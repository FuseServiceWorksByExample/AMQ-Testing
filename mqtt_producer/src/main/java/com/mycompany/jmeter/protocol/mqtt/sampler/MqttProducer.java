package com.mycompany.jmeter.protocol.mqtt.sampler;
...
public class MqttProducer extends AbstractJavaSamplerClient implements Serializable {
    ...
    public static void main(String[] args){
    	String host = "tcp://192.168.49.2:1883";
    ...
    private void setupTest(String host, String topic){
    	try {
